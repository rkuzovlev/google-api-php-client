...
class Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'RKuzovlev\GoogleAPI\Auth\OAuth2',
      // 'io_class'      => self::USE_AUTO_IO_SELECTION,
      'io_class'      => 'RKuzovlev\GoogleAPI\IO\Curl',
      'cache_class'   => 'RKuzovlev\GoogleAPI\Cache\File',
      ...
      'classes' => array(
        'RKuzovlev\GoogleAPI\IO\Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'RKuzovlev\GoogleAPI\Http\Request' => array(
        ...
        'RKuzovlev\GoogleAPI\Auth\OAuth2' => array(
        ...
        'RKuzovlev\GoogleAPI\Cache\File' => array(
